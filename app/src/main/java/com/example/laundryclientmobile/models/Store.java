...
public class Store {
    ...
    public Store(int id, String store_username, String store_email_address, String store_password, String store_name, String store_owner, String store_contact_number, String store_address) {
        this.id = id;
